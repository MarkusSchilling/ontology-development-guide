...
\begin{example}
Alice and other experts brain-storm important concepts for the domain of car manufacturing. Afterwards, this list is filtered with respect to the scope defined earlier. Afterwards, they compile it into a list of todos for future ontology development and document it.
\end{example}
